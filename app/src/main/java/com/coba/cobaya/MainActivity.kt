...
//        getDataDummy()
    ...
    private fun getData() {
        ...
        val projection = arrayOf(BaseColumns._ID, DbContract.DataEntry.COLUMN_NAMA_TITLE, DbContract.DataEntry.COLUMN_NAMA_DESC)

        val sortOrder = "${DbContract.DataEntry.COLUMN_NAMA_TITLE} DESC"
    ...
    private fun getDataDummy() {
        ...
        dataList.add(DataModel(1,"Belajar Java", "Minggu Ini baru masuk"))
        dataList.add(DataModel(1,"Belajar Java 2", "Minggu Ini baru masuk"))
        dataList.add(DataModel(1,"Belajar Java 3", "Minggu Ini baru masuk"))
        dataList.add(DataModel(1,"Belajar Java 4", "Minggu Ini baru masuk"))
        dataList.add(DataModel(1,"Belajar Java 4", "Minggu Ini baru masuk"))
        dataList.add(DataModel(1,"Belajar Java 4", "Minggu Ini baru masuk"))
        dataList.add(DataModel(1,"Belajar Java 4", "Minggu Ini baru masuk"))
        dataList.add(DataModel(1,"Belajar Java 4", "Minggu Ini baru masuk"))
